...
const char *ssid     = "Error183"; // "Error183"; //"SERVICE";
...
String DateTimeStr() {
  return  p2dig(dd) + "/" + p2dig(mm) + "/" + String((RTC.getYear() + 2000)) + " (" + dow2String(wd) + ") " + p2dig(h) + ":" + p2dig(m) + ":" + p2dig(s);
}
